...
var despedida = document.getElementById('contraportada');
var efecto = new Audio('sonidos/camera-flash.mp3');
...
// lanzamos funciones a través de eventos
...
function cambiarEscena_2_3() {
  ...
  belmonte.style.animation = 'rotar 7s'
  efecto.play()
...
function reproducirMusica() {
  if (audio.paused) {
    ...
    icono.setAttribute('title', 'Pausar musica')
  }
  else {
    audio.pause()
